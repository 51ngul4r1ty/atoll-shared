...
export type MenuCaretDownIconProps = StandardInvertibleComponentProps;

export const MenuCaretDownIcon: React.FC<MenuCaretDownIconProps> = (props) => {
    ...
    return (
        <svg
            ...
            xmlSpace="preserve"
        >
            <g className={fillClass} transform="matrix(0.523939,1.24668e-19,1.24668e-19,0.524957,-68.9174,13.0279)">
