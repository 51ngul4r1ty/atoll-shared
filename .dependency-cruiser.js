module.exports = {
    ...
    forbidden: [
        {
            name: "not-atoms-to-molecules",
            comment: "Don't allow dependencies from atoms to molecules or organisms",
            severity: "error",
            from: {
                path: "^src\\/components\\/atoms"
            },
            to: {
                path: "^src\\/components\\/(molecules|organisms)"
            }
        },
        {
            name: "not-molecules-to-organisms",
            comment: "Don't allow dependencies from molecules to organisms",
            severity: "error",
            from: {
    ...
    options: {
        ...
        */
        ...
        focus: "\\/components\\/",
        // TODO: Enable this if you want to focus in on a particular area (this example is for "actions")
        //focus: "\\/actions\\/",
