        ...
        <>
            ...
            >
                ...
                <g id="Layer 1" transform="scale(1 -1)">
                    <g id="Group" strokeLinejoin="miter" stroke="none" fill="black" className={fillClass}>
                        <g id="Group_1">
                            <rect
                                x="-1.499"
                                y="-12.749"
